...
public:
    ...
    void string(unsigned char column, unsigned char page, const unsigned char *font_adress, const char *str);
    void picture(unsigned char column, unsigned char page, const unsigned char *pic_adress);
