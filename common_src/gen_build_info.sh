...
echo "const char git_hash[] = GIT_HASH;" >> "$OUTPUT_FILE"
echo "const char git_branch[] = GIT_BRANCH;" >> "$OUTPUT_FILE"
echo "const char git_tag[] = GIT_TAG;" >> "$OUTPUT_FILE"
echo "const char build_ts[] = BUILD_TIMESTAMP;" >> "$OUTPUT_FILE"
echo "const char build_short_ts[] = BUILD_SHORT_TS;" >> "$OUTPUT_FILE"
echo "#else" >> "$OUTPUT_FILE"
echo "// In all other files, just declare them as extern" >> "$OUTPUT_FILE"
echo "extern const char git_hash[];" >> "$OUTPUT_FILE"
echo "extern const char git_branch[];" >> "$OUTPUT_FILE"
echo "extern const char git_tag[];" >> "$OUTPUT_FILE"
echo "extern const char build_ts[];" >> "$OUTPUT_FILE"
echo "extern const char build_short_ts[];" >> "$OUTPUT_FILE"
